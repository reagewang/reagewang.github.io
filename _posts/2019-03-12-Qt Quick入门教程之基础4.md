...
![img](/images/20190312/7.jpg)

在弹出的新建文件对话框中，选择Qt分类下的 QML File （Qt Quick 2）模板，如下图所示。

![img](/images/20190312/8.jpg)
