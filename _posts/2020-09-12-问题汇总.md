...
## configure编译脚本
./../qt-everywhere-opensource-src-5.9.9/configure -verbose -opensource -release -shared -confirm-license -opengl es2 -nomake tools -nomake examples -nomake tests -xplatform linux-arm-gnueabi-g++ -prefix /opt/qt5.9.9_nvidia_arm_opengl -I/opt/rootfs_nano/usr/include -L/opt/rootfs_nano/usr/lib
