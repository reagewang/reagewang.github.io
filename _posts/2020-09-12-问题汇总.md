...
export PATH="/opt/Qt5.9.9/Tools/QtCreator/bin:$PATH"
...
## configure编译脚本
./../qt-everywhere-opensource-src-5.9.9/configure -verbose -opensource -release -shared -confirm-license -opengl es2 -nomake tools -nomake examples -nomake tests -no-iconv -no-assimp -no-qt3d-profile-jobs -no-qt3d-profile-gl -xplatform linux-arm-gnueabi-g++ -prefix /opt/qt5.9.9_nvidia_arm_opengl -I/usr/include -L/usr/lib
