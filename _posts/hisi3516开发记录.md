...
盛视科技股份有限公司 版本 V3.0.0.1

需求切图元素:
登录界面 主背景图
黑名单界面 左上角黑名单文字的背景图 右上角的返回图标
黑名单界面 列表框的大小，表头的高度，表项的高度
设备管理界面 左上角设备管理文字的背景图 版本信息图标
首页界面 主界面图标 设备管理图标 黑名单图标 图片浏览图标
图片浏览界面 左右翻页的三角形图标
